            ...
            <div class="catalog-header">
                ...
                <div class="chips" id="categoryChips">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="chip" type="button" data-category="<?php echo e($category->id); ?>"><?php echo e($category->name); ?></button>
            ...
            <div class="catalog-grid" id="catalogGrid">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="product-card"
                             style="--i:<?php echo e($idx); ?>"
                             data-name="<?php echo e(strtolower($product->marque . ' ' . $product->modele . ' ' . ($product->codebar ?? '') . ' ' . ($product->reference ?? ''))); ?>"
                             data-category="<?php echo e($product->category_id ?? 'none'); ?>"
                             data-id="<?php echo e($product->id); ?>"
                             data-code="<?php echo e($product->codebar); ?>">
                        <div class="product-image">
                            <?php if($product->image): ?>
                                <img src="<?php echo e(asset($product->image)); ?>" alt="<?php echo e($product->marque); ?>">
                            <?php else: ?>
                                <span class="text-muted small">Pas d'image</span>
                            <?php endif; ?>
                        </div>
                        <div class="product-meta">
                            <div class="product-title"><?php echo e($product->marque); ?></div>
                            <div class="product-sub">Ref: <?php echo e($product->reference ?: '-'); ?></div>
                            <div class="product-sub"><?php echo e($product->category ? $product->category->name : ($product->categorie ?: 'Produit')); ?></div>
                            <div class="product-bottom">
                                <span class="product-price"><?php echo e(number_format($product->prix_vente, 2)); ?> DH</span>
                                <span class="product-sub">Stock <?php echo e($product->quantite); ?></span>
                            </div>
...
const addUrl = "<?php echo e(route('caisse.add')); ?>";
...
function storeTicketInfos() {
    return fetch("<?php echo e(route('caisse.storeInfosTicket')); ?>", {
        method: 'POST',
        headers: {
