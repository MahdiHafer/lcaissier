...
@endphp
        ...
        <div class="header-right">
            <div class="doc-box">
                <div class="doc-box-row">
                    <span class="doc-label">Numero BL</span>
                    <span class="doc-value">{{ $bon->numero }}</span>
                </div>
                <div class="doc-box-row">
                    <span class="doc-label">Date</span>
                    <span class="doc-value">{{ \Carbon\Carbon::parse($bon->date_bon)->format('d/m/Y') }}</span>
                </div>
                <div class="doc-box-row">
                    <span class="doc-label">Client</span>
                    <span class="doc-value">{{ optional($bon->client)->nom ?: 'Client comptoir' }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="client-card">
        ...
        <div class="client-name">{{ optional($bon->client)->nom ?: 'Client comptoir' }}</div>
        @if(optional($bon->client)->telephone)
            <div>{{ $bon->client->telephone }}</div>
        @endif
    </div>
    ...
    @if(!empty($bon->notes))
        <div class="notes"><strong>Notes :</strong><br>{{ $bon->notes }}</div>
    @endif
    </div>
