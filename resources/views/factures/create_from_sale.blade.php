...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="m-0">Vente {{ $vente->numero_ticket }} -> Facture</h2>
    ...
    <div class="card p-3 mb-3">
        <div class="row g-2">
            ...
            <div class="col-md-4"><strong>Client:</strong> {{ optional($vente->clientInfo)->nom ?: 'Client comptoir' }}</div>
            <div class="col-md-2 text-md-end"><strong>Total vente:</strong> {{ number_format($vente->total, 2) }} DH</div>
        </div>
    </div>

    <form method="POST" action="{{ route('ventes.facture.store', $vente) }}" class="card p-3" id="createInvoiceForm">
        @csrf
